<div class="max-w-7xl mx-auto">
    ...
    <div class="mb-8 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
            <h1 class="text-2xl font-bold text-gray-900"><?= e($company['name']) ?> Images & Banners</h1>
            <p class="text-sm text-gray-500 mt-1">Brand imagery, backgrounds, and social banners</p>
        </div>
    ...
    <div class="text-center py-20 bg-white rounded-2xl border border-gray-100 border-dashed">
        ...
        <h3 class="text-lg font-medium text-gray-900">No images yet</h3>
        <p class="text-gray-500 mt-1">Upload banners and social media images here.</p>
